...
export default function OnboardingFlow({ stage = 'path', onStage, onSkip, onCreate, onMigrate, onSettings, onImport, onBaseline }: {
  ...
  if (stage === 'migration' || stage === 'editor' || stage === 'editor-reposition' || stage === 'floors' || stage === 'settings' || stage === 'team' || stage === 'team-add' || stage === 'team-exit' || stage === 'location' || stage === 'import') return null;
