...
export default function OnboardingFlow({ stage = 'path', onStage, onSkip, onCreate, onMigrate, onSettings, onImport, onBaseline }: {
  ...
  if (stage === 'baseline') {
    ...
    const setRanges = (kind: 'slow' | 'busy', ranges: SeasonRange[]) => setBaseline(b => ({ ...b, seasons: { ...((b.seasons as Seasons) || {}), [kind]: ranges } }));
