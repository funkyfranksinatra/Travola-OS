...
function LoginForm() {
  ...
  return <main className="min-h-screen bg-[#101113] text-[#ecebe6] flex items-center justify-center p-5 font-mono">
    <section className="w-full max-w-sm rounded-xl border border-white/10 bg-[#18191d] p-7 shadow-2xl">
      <div className="mb-8 flex items-center gap-3"><div className="grid h-10 w-10 place-items-center rounded-lg bg-cyan-300 text-lg font-black text-[#101113]">T</div><div><h1 className="text-sm font-semibold tracking-[0.24em]">TRAVOLA</h1><p className="mt-1 text-[10px] tracking-[0.16em] text-white/45">{host ? "HOST STAND" : register ? "NEW RESTAURANT" : "MANAGER"}</p></div></div>
